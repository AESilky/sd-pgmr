...
// loaded onto the 1106/1306 based display more easily. Each character
// takes 2 bytes:
// +---+---+++---+---+---+---++---+---+---+---+
// | 9 | 8 ||| 7 | 6 | 5 | 4 || 3 | 2 | 1 | 0 |
// +---+---+++---+---+---+---++---+---+---+---|
...
const uint16_t Font_Table[] =
{
	...
	// 0x01 < Copyright > (9 wide x 10 high cell)
	//      // 9 8|7 6 5 4|3 2 1 0
	//      // - -|- - - -|- - - -
	0x007C, //       # # # # #
	0x00C6, //     # #       # #
	...
	// 0x1A 'DOWN ARROW HEAD' (9 wide x 10 high cell)
	//      // 9 8|7 6 5 4|3 2 1 0
	//      // - -|- - - -|- - - -
	0x0000, //
	0x0020, //         #
	...
	// 0x1B 'UP ARROW HEAD) ' (9 wide x 10 high cell)
	//      // 9 8|7 6 5 4|3 2 1 0
	//      // - -|- - - -|- - - -
	0x0000, //
	0x0008, //             #
